...
function getImageURLs($keyword, $orientation="horizontal") {
    ...
    curl_setopt_array($curl, array(
      ...
      CURLOPT_URL => "https://pixabay.com/api/?key=6608702-1947cbe1e0be9d18ef7fd89f5&q=$keyword&image_type=photo&orientation=$orientation&safesearch=true&per_page=100",
